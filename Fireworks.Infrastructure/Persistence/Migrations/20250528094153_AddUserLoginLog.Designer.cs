...
namespace Fireworks.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250528094153_AddUserLoginLog")]
    partial class AddUserLoginLog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fireworks.Domain.Identity.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Fireworks.Domain.Entities.UserLoginLog", b =>
                {
                    b.HasOne("Fireworks.Domain.Identity.Entities.ApplicationUser", "User")
                        .WithMany()
